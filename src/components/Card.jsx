...
const Card = ({id,title,img}) => {
  return (
    <div key={id} className="card  h-[40vh] bg-[#f1faee] rounded-xl flex flex-col items-center justify-between overflow-hidden gap-2 border-4 border-[#f1faee] shadow-xl">
      ...
      <div className="desc flex items-center justify-between w-full pt-2.5 bg-[#1d3557] px-4 py-3 text-[#f1faee]">
        <p className='font-semibold'>{title.length >15 ? title.substring(0,10) + "..." : title}</p>
